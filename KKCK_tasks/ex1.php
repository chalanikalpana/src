...
<body>
    ...
    <?php
    //use backlash ti escape special characters like "
    ...
    ?>
    <h3>3.2 Create a PHP variable named $title
         and assign it the value "PHP is interesting."
          Then, use this variable as the content within 
          an (heading 4) element.</h3>
